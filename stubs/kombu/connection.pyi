...
class Connection:
    ...
    def __init__(
        ...
        connect_timeout: int = ...,
        transport_options: Optional[Any] = ...,
        login_method: Optional[Any] = ...,
        uri_prefix: Optional[Any] = ...,
        heartbeat: int = ...,
        failover_strategy: str = ...,
    ...
    def ensure(
        ...
        max_retries: Optional[Any] = ...,
        interval_start: int = ...,
        interval_step: int = ...,
        interval_max: int = ...,
        on_revive: Optional[Any] = ...,
    ): ...
    def autoretry(
        self, fun: Any, channel: Optional[Any] = ..., **ensure_options: Any
    ): ...
    ...
    def __eqhash__(self): ...
    def as_uri(
        self, include_password: bool = ..., mask: str = ..., getfields: Any = ...
    ): ...
...
class ConnectionPool(Resource):
    ...
    connection: Any = ...
    def __init__(
        self, connection: Any, limit: Optional[Any] = ..., **kwargs: Any
    ) -> None: ...
    def new(self): ...
